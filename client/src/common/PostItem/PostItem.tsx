...
const PostItem = (
  ...
  const sendFriendRequest = () => {
    ...
    if (+author == +user_id) {
      return alert("Вы не можете отправить запрос самому себе")
    }
  ...
  return (
    <div className={styles.post_item}>
      ...
      <div className={styles.post_item__header_block}>
      ...
      <div className={styles.post_item__content_block}>
      ...
      <div className={styles.post_item__share_box}>
