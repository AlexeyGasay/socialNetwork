        ...
        <div className={styles.user_info_block}>
          ...
          <div className={styles.user_background}>
            ...
            <div className={styles.user_avatar_block} >
              ...
              <img className={styles.user_avatar} src={`${dbURL}/static/file_1654619394078.jpeg`} alt="user_avatar" />
          ...
          <div className={styles.user_info}>
            <p className={styles.user_status}>{userInfo.length > 0 ? userInfo[0].username : null}</p>
          </div>
